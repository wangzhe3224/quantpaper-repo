...
$$r_{i,t} = egin{cases} PT, & 	ext{if } H_{i,t:t+	ext{MHP}} - O_{i,t} \geq PT \ SL, & 	ext{if } L_{i,t:t+	ext{MHP}} - O_{i,t} \leq SL \ C_{i,t+	ext{MHP}} - O_{i,t}, & 	ext{otherwise} nd{cases}$$
...
![Scenario analysis boxplot for CVLT](https://github.com/wangzhe3224/quantpaper-repo/blob/main/2509.16707v2/images/page14_img1.png)
...
$$	ext{Accuracy} = rac{	ext{Number of correctly predicted directions}}{	ext{Total number of predictions}} 	imes 100\%$$
...
$$z = rac{\hat{p} - p_0}{SE_0}$$

The 95% confidence interval is computed using the Wald interval:

$$CI = \hat{p} \pm z_{lpha/2} 	imes SE_{\hat{p}}, \quad 	ext{where} \quad SE_{\hat{p}} = \sqrt{rac{\hat{p}(1-\hat{p})}{n}}$$
...
![Confidence interval plots through end of 2024](https://github.com/wangzhe3224/quantpaper-repo/blob/main/2509.16707v2/images/page17_img1.png)
...
![Confidence interval plots for Q1-Q2 2025](https://github.com/wangzhe3224/quantpaper-repo/blob/main/2509.16707v2/images/page18_img1.png)
...
![CVLT strategy returns and risk](https://github.com/wangzhe3224/quantpaper-repo/blob/main/2509.16707v2/images/page19_img1.png)
...
![Long accuracy before/after Jan 2025](https://github.com/wangzhe3224/quantpaper-repo/blob/main/2509.16707v2/images/page22_img1.png)

*Fig. 5. Scatter plot showing the long accuracy of the trading signals, before and after January 2025.*

![Short accuracy before/after Jan 2025](https://github.com/wangzhe3224/quantpaper-repo/blob/main/2509.16707v2/images/page28_img1.png)
...
![MDDEW portfolio performance](https://github.com/wangzhe3224/quantpaper-repo/blob/main/2509.16707v2/images/page29_img1.png)
...
![Long-leg stock turnover grid](https://github.com/wangzhe3224/quantpaper-repo/blob/main/2509.16707v2/images/page31_img1.png)
...
![Short-leg stock turnover grid](https://github.com/wangzhe3224/quantpaper-repo/blob/main/2509.16707v2/images/page33_img1.png)
...
![MDDEW portfolio with 2x leverage](https://github.com/wangzhe3224/quantpaper-repo/blob/main/2509.16707v2/images/page34_img1.png)
